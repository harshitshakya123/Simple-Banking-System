...
public class Withdrawl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response)
	 ...
	 try {
    	...
    	//x is User Withdrawl ammount
     	int x= Integer.parseInt(request.getParameter("withdrawl"));
     	...
     	if(session!=null){
            ...
            //y is already Withdrawl ammount in a particular login field
            int y=0;
            if(r.next()) 
            {
              y=Integer.parseInt(r.getString(1));
            }
            //z is subtraction of user Withdrawl ammount + already Withdrawl ammount
            int z =y-x;
